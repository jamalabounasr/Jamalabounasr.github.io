...
{% if blog_name_size > 0 or blog_description_size > 0 %}
  ...
  <div class="card p-3 mt-4 mb-4">
    <p class="mb-2" style="font-size: 1.05rem;">
      A personal space for trip photos, conference moments, and the little wins (and lessons) along the PhD ride.
    </p>
    <div class="d-flex flex-wrap gap-3" style="opacity: 0.9;">
      <span><i class="fa-solid fa-camera"></i> Photos</span>
      <span><i class="fa-solid fa-location-dot"></i> Places</span>
      <span><i class="fa-solid fa-microphone-lines"></i> Conferences</span>
      <span><i class="fa-solid fa-wifi"></i> RF / Wearables</span>
      <span><i class="fa-solid fa-mug-hot"></i> Fun bits</span>
    </div>
</div>
{% endif %}
...
<div class="container featured-posts">
  ...
  <div class="row row-cols-{% if featured_posts.size <= 2 or is_even == 0 %}2{% else %}3{% endif %}">
    {% for post in featured_posts %}
      {% unless post.categories contains "sample-posts" or post.categories contains "external-posts" %}
        <div class="col mb-4">
